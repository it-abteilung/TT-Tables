...
TableExtension 50025 tableextension50025 extends "Purch. Cr. Memo Hdr."
{
    fields
    {
        ...
        {
            CalcFormula = sum("Purch. Cr. Memo Line"."CO2 Menge in Kilogramm" where("Document No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
